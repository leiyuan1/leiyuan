...
* @Last Modified time: 2017-09-22 13:12:19
*/
...
// 	   console.log(ysTop)
   ...
   tiaozhuans.forEach(function(element,index){
          ...
          // let tiao=document.body || document.documentElement;
     	  	    animate(document.documentElement,{scrollTop:stArr[index]-100},1000)
...
// console.log(down);
   window.onscroll=function(){
   	     let hd=document.body.scrollTop || document.documentElement.scrollTop;;
